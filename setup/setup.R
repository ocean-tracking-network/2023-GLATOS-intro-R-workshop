...
### Dataset and Code -----
# Once the packages are installed, you can download the datasets and code for this workshop from https://github.com/ocean-tracking-network/2023-GLATOS-intro-R-workshop/tree/master.
...
# by running `git clone https://github.com/ocean-tracking-network/2023-GLATOS-intro-R-workshop/tree/master.git` in a terminal program
